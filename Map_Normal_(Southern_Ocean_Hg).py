...
#SIPEXII
SIPEXII = pd.read_csv('/Users/ncp532/Documents/Data/SIPEXII_2012/SIPEX_II_Mercury_Air/SIPEXII_Hg0_Lat_Long.csv') # Hg0 data for SIPEXII (2012)
...
#PCAN
RVInv = pd.read_csv('/Users/ncp532/Documents/Data/PCAN_2017/RVInvestigator_Hg0_Lat_Long.csv') # Hg0 data for RVInv (2017)
...
#CHINARE
CHINARE = pd.read_csv('/Users/ncp532/Documents/Data/CHINARE_2012_13/CHINARE_Hg0_Lat_Long.csv') # Hg0 data for RVXue (2014/15)
...
#CAMMPCAN (2017/18)
#V1
V1_17_18 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/CAMMPCAN_V1_Hg0_Lat_Long_17-18.csv') # Hg0 data for CAMPCANN V1 (2017/18)
...
#V2
V2_17_18 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/CAMMPCAN_V2_Hg0_Lat_Long_17-18.csv') # Hg0 data for CAMPCANN V2 (2017/18)
...
#V3
V3_17_18 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/CAMMPCAN_V3_Hg0_Lat_Long_17-18.csv') # Hg0 data for CAMPCANN V3 (2017/18)
...
#V4
V4_17_18 = pd.read_csv('/Users/ncp532/Documents/Data/CAMMPCAN_2017_18/CAMMPCAN_V4_Hg0_Lat_Long_17-18.csv') # Hg0 data for CAMPCANN V4 (2017/18)
...
def plotkg(x, bar, tit):  # (x = the value to be plotted, bar = colorbar (Y/N), tit = title for map)
    ...
    x4,y4 = m(lons4, lats4)
    obs = RVInv_Hg0
    m.scatter(x4, y4, c=obs, vmin=0.4, vmax=1.6, cmap=cm.plasma, s=10) # define the location markers (color=obs, you need to set vmin/vmax and the cmap to same values as the colorbar above)  
    ...
    x5,y5 = m(lons5, lats5)
    obs = V1_17_18_Hg0
    m.scatter(x5, y5, c=obs, vmin=0.4, vmax=1.6, cmap=cm.plasma, s=10) # define the location markers (color=obs, you need to set vmin/vmax and the cmap to same values as the colorbar above)  
    #V2
    lons6 = V2_17_18_Long
    lats6 = V2_17_18_Lat
    x6,y6 = m(lons6, lats6)
    obs = V2_17_18_Hg0
    m.scatter(x6, y6, c=obs, vmin=0.4, vmax=1.6, cmap=cm.plasma, s=10) # define the location markers (color=obs, you need to set vmin/vmax and the cmap to same values as the colorbar above)  
    #V3
    lons7 = V3_17_18_Long
    lats7 = V3_17_18_Lat
    x7,y7 = m(lons7, lats7)
    obs = V3_17_18_Hg0
    m.scatter(x7, y7, c=obs, vmin=0.4, vmax=1.6, cmap=cm.plasma, s=10) # define the location markers (color=obs, you need to set vmin/vmax and the cmap to same values as the colorbar above)  
    #V4
    lons8 = V4_17_18_Long
    lats8 = V4_17_18_Lat
    x8,y8 = m(lons8, lats8)
    obs = V4_17_18_Hg0
    m.scatter(x8, y8, c=obs, vmin=0.4, vmax=1.6, cmap=cm.plasma, s=10) # define the location markers (color=obs, you need to set vmin/vmax and the cmap to same values as the colorbar above)  
    ...
    obs = RVXue_Hg0
    m.scatter(x13, y13, c=obs, vmin=0.4, vmax=1.6, cmap=cm.plasma, s=10) # define the location markers (color=obs, you need to set vmin/vmax and the cmap to same values as the colorbar above)  
    ...
    obs = CHINARE_Hg0
    m.scatter(x14, y14, c=obs, vmin=0.4, vmax=1.6, cmap=cm.plasma, s=10) # define the location markers (color=obs, you need to set vmin/vmax and the cmap to same values as the colorbar above)  
...
ax1 = plotkg(Hg0_Av[:,:], 'Y', "Simulated GEM Concentrations (Sept & Oct 2012)") # Hg$^0$ Note that Hg0 is an array Hg0['time','lev','lat','lon']
#ax1 = plt.subplot(111) # subplot(number of figures vertical, number of figures horizontal, total number of figures)

...
# Sea Ice
#-------------
SeaIce_V1_17A   = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/OISST_SeaIce/2017-18/oisst-avhrr-v02r01.20171114.nc', decode_cf=False, engine='netcdf4')
SeaIce_V1_17D   = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/OISST_SeaIce/2017-18/oisst-avhrr-v02r01.20171112.nc', decode_cf=False, engine='netcdf4')

SeaIce_V2_17A   = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/OISST_SeaIce/2017-18/oisst-avhrr-v02r01.20171221.nc', decode_cf=False, engine='netcdf4')
SeaIce_V2_17D   = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/OISST_SeaIce/2017-18/oisst-avhrr-v02r01.20180105.nc', decode_cf=False, engine='netcdf4')

SeaIce_V3_17A  = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/OISST_SeaIce/2017-18/oisst-avhrr-v02r01.20180201.nc', decode_cf=False, engine='netcdf4')
SeaIce_V3_17D  = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/OISST_SeaIce/2017-18/oisst-avhrr-v02r01.20180217.nc', decode_cf=False, engine='netcdf4')
...
ax.text(0.05, 0.105, "14 Nov 2017", transform=ax.transAxes, fontsize=12, verticalalignment='top', bbox=props)
...
# Text box in upper left
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax.text(0.05, 0.105, "22 Nov 2017", transform=ax.transAxes, fontsize=12, verticalalignment='top', bbox=props)
...
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax.text(0.05, 0.105, "21 Dec 2017", transform=ax.transAxes, fontsize=12, verticalalignment='top', bbox=props)
...
# Text box in upper left
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax.text(0.05, 0.105, "5 Jan 2018", transform=ax.transAxes, fontsize=12, verticalalignment='top', bbox=props)
...
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax.text(0.05, 0.105, "1 Feb 2018", transform=ax.transAxes, fontsize=12, verticalalignment='top', bbox=props)
...
# Text box in upper left
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax.text(0.05, 0.105, "17 Feb 2018", transform=ax.transAxes, fontsize=12, verticalalignment='top', bbox=props)

...
# Sea Ice
#-------------
SeaIce_V1_17A   = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/OISST_SeaIce/2012/oisst-avhrr-v02r01.20120923.nc', decode_cf=False, engine='netcdf4')
SeaIce_V1_17D   = xr.open_dataset('/Users/ncp532/Documents/Data/Sea_Ice_Cover/OISST_SeaIce/2012/oisst-avhrr-v02r01.20121118.nc', decode_cf=False, engine='netcdf4')
...
SIPEXII_lon, SIPEXII_lat = -60.06, 123.5 # -61.76, 121.2
...
ax.plot(SIPEXII_lat, SIPEXII_lon, transform=data_crs, color='r', marker='o')
...
ax.text(SIPEXII_lat - 2, SIPEXII_lon + 8, 'SIPEXII',transform=data_crs, horizontalalignment='right')
...
ax.text(0.05, 0.105, "9 Sep 2012", transform=ax.transAxes, fontsize=12, verticalalignment='top', bbox=props)
...
Mawson_lon,  Mawson_lat  = -67.6027, 62.8738
Casey_lon,   Casey_lat   = -66.2818, 110.5276
SIPEXII_lon, SIPEXII_lat = -60.61, 122.2 # -62.24, 115.5
...
# Text box in upper left
props = dict(boxstyle='round', facecolor='white', alpha=1.0)
ax.text(0.05, 0.105, "11 Nov 2012", transform=ax.transAxes, fontsize=12, verticalalignment='top', bbox=props)
